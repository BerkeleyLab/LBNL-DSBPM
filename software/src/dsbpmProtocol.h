...
#define DSBPM_PROTOCOL_MAGIC_SLOW_ACQUISITION   0xD06F9D92
...
struct dsbpmSlowAcquisition {
    ...
    epicsUInt32 dacPwr[DSBPM_PROTOCOL_DAC_COUNT];
};
...
#define DSBPM_PROTOCOL_CMD_HI_SYSMON2           0x3000
# define DSBPM_PROTOCOL_CMD_SYSMON2_LO_INT32       0x0000
# define DSBPM_PROTOCOL_CMD_SYSMON2_LO_UINT16_LO   0x0100
# define DSBPM_PROTOCOL_CMD_SYSMON2_LO_UINT16_HI   0x0200
# define DSBPM_PROTOCOL_CMD_SYSMON2_LO_INT16_LO    0x0300
# define DSBPM_PROTOCOL_CMD_SYSMON2_LO_INT16_HI    0x0400
...
#define DSBPM_PROTOCOL_CMD_HI_OCTET         0x6000
# define DSBPM_PROTOCOL_CMD_OCTET_IDX_NAME           0x00
# define DSBPM_PROTOCOL_CMD_OCTET_IDX_REV            0x01
# define DSBPM_PROTOCOL_CMD_OCTET_IDX_SN             0x02
# define DSBPM_PROTOCOL_CMD_OCTET_IDX_MAC            0x03
# define DSBPM_PROTOCOL_CMD_OCTET_IDX_ACTIVE         0x04
# define DSBPM_PROTOCOL_CMD_OCTET_IDX_CFG_MODE       0x05
