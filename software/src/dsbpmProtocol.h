...
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_PRETRIGGER_COUNT_SET    0x0300
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_ACQUISITION_COUNT_SET   0x0400
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_ACQUISITION_MODE_SET    0x0500
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_SOFT_TRIGGER            0x0600
