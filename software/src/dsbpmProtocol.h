...
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_ARM_SET                 0x0000
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_ARM_GET                 0x0100
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_TRIGGER_MASK_SET        0x0200
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_TRIGGER_MASK_GET        0x0300
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_PRETRIGGER_COUNT_SET    0x0400
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_PRETRIGGER_COUNT_GET    0x0500
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_ACQUISITION_COUNT_SET   0x0600
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_ACQUISITION_COUNT_GET   0x0700
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_ACQUISITION_MODE_SET    0x0800
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_ACQUISITION_MODE_GET    0x0900
# define DSBPM_PROTOCOL_CMD_RECORDERS_LO_SOFT_TRIGGER            0x0A00
