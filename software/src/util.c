...
#define TARGET_VARIANT_NAME_STR             STRINGIFY(__TARGET_VARIANT_NAME__)
#define TARGET_SAMPLES_PER_TURN_NAME_STR    STRINGIFY(__TARGET_SAMPLES_PER_TURN_NAME__)
#define TARGET_VCXO_TYPE_NAME_STR           STRINGIFY(__TARGET_VCXO_TYPE_NAME__)
#define TARGET_NAME_STR                     STRINGIFY(__TARGET_NAME__)
