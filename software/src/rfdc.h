...
void rfDCinit(void);
void rfDCADCsync(void);
void rfDCDACsync(void);
void rfDCsync(void);
...
int rfDACGetShutdownModeBPM(unsigned int bpm, int channel);
void rfDACSetShutdownModeBPM(unsigned int bpm, int channel, int on);
