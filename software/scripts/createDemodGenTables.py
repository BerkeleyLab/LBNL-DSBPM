...
writeTable('ptTableSR_81_328_L7_19_H11_19_bin_20_conjugate.csv',
           ptDemodTableGen((499.64/328.0)*(1+7.0/19.0), (499.64/328.0)*(1+11.0/19.0),
                           ...
                           Feff = 499.64/328*20, conjugate = True))
writeTable('ptTableSR_73_304_L13_41_H23_41_bin_20_conjugate.csv',
           ptDemodTableGen((500.392/304.0)*(1+13.0/41.0), (500.392/304.0)*(1+23.0/41.0),
...
###############################################################################
writeTable('ptGen_81_L7_H11_19.csv',
...
writeTable('ptGen_77_L7_H11_19.csv',
           ptGenTable((499.64/328.0)*(1+7.0/19.0), (499.64/328.0)*(1+11.0/19.0),
                           499.64, 328, 77, 77*19, scaleFactor = args.ptScaleFactor,
                           Feff = 0, conjugate = False))
writeTable('ptGen_73_L13_H23_41.csv',
           ptGenTable((500.392/304.0)*(1+13.0/41.0), (500.392/304.0)*(1+23.0/41.0),
