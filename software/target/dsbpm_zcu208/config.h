...
/*
 *  Recorder capacities, in Bytes. Each recorder usually
 *  has 4 channels, 4-byte, each.
 */
#define CFG_RECORDER_ADC_SAMPLE_CAPACITY (32*1024*1024) * (4*4)
#define CFG_RECORDER_TBT_SAMPLE_CAPACITY (16*1024*1024) * (4*4)
#define CFG_RECORDER_FA_SAMPLE_CAPACITY  (16*1024*1024) * (4*4)
#define CFG_RECORDER_PT_SAMPLE_CAPACITY  (4*1024*1024) *  (4*4)
