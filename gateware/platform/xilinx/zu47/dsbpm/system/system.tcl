...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./gateware/platform/xilinx/zu47/dsbpm
...
proc create_root_design { parentCell } {
  ...
  set adc0Qstream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc0Qstream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc0Qstream

  set adc0stream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc0stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc0stream

  set adc1Qstream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc1Qstream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc1Qstream

  set adc1stream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc1stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc1stream

  set adc23 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 adc23 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {500000000} \
   ] $adc23

  set adc2Qstream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc2Qstream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc2Qstream

  set adc2stream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc2stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc2stream

  set adc3Qstream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc3Qstream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc3Qstream

  set adc3stream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc3stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc3stream

  set adc4Qstream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc4Qstream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc4Qstream

  set adc4stream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc4stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc4stream

  set adc5Qstream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc5Qstream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc5Qstream

  set adc5stream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc5stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc5stream

  set adc6Qstream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc6Qstream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc6Qstream

  set adc6stream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc6stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc6stream

  set adc7Qstream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc7Qstream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc7Qstream

  set adc7stream [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 adc7stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   ] $adc7stream

  set dac0stream [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 dac0stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
  ...
  set dac1stream [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 dac1stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
  ...
  set dac2stream [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 dac2stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
  ...
  set dac3stream [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 dac3stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
  ...
  set dac45 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 dac45 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {500000000} \
   ] $dac45

  set dac4stream [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 dac4stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
  ...
  set dac5stream [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 dac5stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
  ...
  set dac6stream [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 dac6stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
  ...
  set dac7stream [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 dac7stream ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {123386707} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
  ...
  set ddr_aximm_dbg [ create_bd_intf_port -mode Monitor -vlnv xilinx.com:interface:aximm_rtl:1.0 ddr_aximm_dbg ]
  set_property -dict [ list \
  ...
  set vin4 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_analog_io_rtl:1.0 vin4 ]

  set vin5 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_analog_io_rtl:1.0 vin5 ]

  set vin6 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_analog_io_rtl:1.0 vin6 ]

  set vin7 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_analog_io_rtl:1.0 vin7 ]
  ...
  set wr_adc_0_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_adc_0_axi ]
  set_property -dict [ list \
  ...
  set wr_adc_1_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_adc_1_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_fa_0_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_fa_0_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_fa_1_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_fa_1_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_fa_pos_0_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_fa_pos_0_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_fa_pos_1_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_fa_pos_1_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_ph_0_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_ph_0_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_ph_1_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_ph_1_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_pl_0_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_pl_0_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_pl_1_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_pl_1_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_tbt_0_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_tbt_0_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_tbt_1_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_tbt_1_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_tbt_pos_0_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_tbt_pos_0_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  set wr_tbt_pos_1_axi [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 wr_tbt_pos_1_axi ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {35} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  # Create ports
  set FPGA_REFCLK_OUT_C [ create_bd_port -dir I -type clk -freq_hz 499640000 FPGA_REFCLK_OUT_C ]
  set GPIO_IN [ create_bd_port -dir I -from 32767 -to 0 GPIO_IN ]
  set GPIO_OUT [ create_bd_port -dir O -from 31 -to 0 GPIO_OUT ]
  set GPIO_STROBES [ create_bd_port -dir O -from 1023 -to 0 GPIO_STROBES ]
  set adcClk [ create_bd_port -dir O -type clk adcClk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {adc0stream:adc1stream:adc2stream:adc3stream:adc4stream:adc5stream:adc6stream:adc7stream:adc0Qstream:adc1Qstream:adc2Qstream:adc3Qstream:adc4Qstream:adc5Qstream:adc6Qstream:adc7Qstream:wr_adc_0_axi:wr_adc_1_axi} \
   CONFIG.FREQ_HZ {123386707} \
 ] $adcClk
  set adcClkLocked [ create_bd_port -dir O adcClkLocked ]
  set clk_adc0_0 [ create_bd_port -dir O -type clk clk_adc0_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {38558000} \
 ] $clk_adc0_0
  set clk_dac0_0 [ create_bd_port -dir O -type clk clk_dac0_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {308467000} \
 ] $clk_dac0_0
  set dacClk [ create_bd_port -dir O -type clk dacClk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {dac0stream:dac1stream:dac2stream:dac3stream:dac4stream:dac5stream:dac6stream:dac7stream} \
   CONFIG.FREQ_HZ {123386707} \
 ] $dacClk
  set dacClkLocked [ create_bd_port -dir O dacClkLocked ]
  set ddr4_calib_complete [ create_bd_port -dir O -type data ddr4_calib_complete ]
  set ddr4_rst [ create_bd_port -dir O -type rst ddr4_rst ]
  set ddr4_ui_clk [ create_bd_port -dir O -type clk ddr4_ui_clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {ddr_aximm_dbg} \
 ] $ddr4_ui_clk
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {wr_tbt_0_axi:wr_fa_0_axi:wr_pl_0_axi:wr_ph_0_axi:wr_tbt_1_axi:wr_fa_1_axi:wr_pl_1_axi:wr_ph_1_axi:wr_tbt_pos_0_axi:wr_fa_pos_0_axi:wr_tbt_pos_1_axi:wr_fa_pos_1_axi} \
 ] $sysClk
  set sysReset_n [ create_bd_port -dir O -from 0 -to 0 -type rst sysReset_n ]
  ...
  set axi_lite_generic_reg_0 [ create_bd_cell -type ip -vlnv lbl.gov:user:axi_lite_generic_reg:2.0 axi_lite_generic_reg_0 ]
  set_property -dict [ list \
   CONFIG.C_S00_AXI_ADDR_WIDTH {12} \
 ] $axi_lite_generic_reg_0
  ...
  set ddr4_smc_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 ddr4_smc_0 ]
  set_property -dict [ list \
   CONFIG.NUM_CLKS {3} \
   CONFIG.NUM_SI {15} \
 ] $ddr4_smc_0
  ...
  set rfadc_mmcm [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 rfadc_mmcm ]
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {20.01} \
   CONFIG.CLKOUT1_DRIVES {BUFG} \
   CONFIG.CLKOUT1_JITTER {190.914} \
   CONFIG.CLKOUT1_PHASE_ERROR {338.733} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {123.38671} \
   CONFIG.CLKOUT2_DRIVES {Buffer} \
   CONFIG.CLKOUT2_JITTER {190.914} \
   CONFIG.CLKOUT2_PHASE_ERROR {338.733} \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {101.250} \
   CONFIG.MMCM_CLKIN1_PERIOD {2.001} \
   CONFIG.MMCM_CLKIN2_PERIOD {10.0} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {10.000} \
   CONFIG.MMCM_CLKOUT1_DIVIDE {1} \
   CONFIG.MMCM_DIVCLK_DIVIDE {41} \
   CONFIG.NUM_OUT_CLKS {1} \
   CONFIG.PRIM_IN_FREQ {499.640} \
  ...
  # Create instance: rst_ddr_mig_0, and set properties
  set rst_ddr_mig_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ddr_mig_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC0_Outclk_Freq {38.558} \
   CONFIG.ADC0_PLL_Enable {false} \
   CONFIG.ADC0_Refclk_Freq {4935.468} \
   CONFIG.ADC0_Sampling_Rate {4.935468} \
   CONFIG.ADC1_Clock_Dist {1} \
   CONFIG.ADC1_Link_Coupling {0} \
   CONFIG.ADC1_Multi_Tile_Sync {true} \
   CONFIG.ADC1_Outclk_Freq {38.558} \
   CONFIG.ADC1_PLL_Enable {false} \
   CONFIG.ADC1_Refclk_Freq {4935.468} \
   CONFIG.ADC1_Sampling_Rate {4.935468} \
   ...
   CONFIG.ADC2_Outclk_Freq {38.558} \
   CONFIG.ADC2_PLL_Enable {false} \
   CONFIG.ADC2_Refclk_Freq {4935.468} \
   CONFIG.ADC2_Sampling_Rate {4.935468} \
   CONFIG.ADC3_Clock_Source {1} \
   CONFIG.ADC3_Link_Coupling {0} \
   CONFIG.ADC3_Multi_Tile_Sync {true} \
   CONFIG.ADC3_Outclk_Freq {38.558} \
   CONFIG.ADC3_PLL_Enable {false} \
   CONFIG.ADC3_Refclk_Freq {4935.468} \
   CONFIG.ADC3_Sampling_Rate {4.935468} \
   ...
   CONFIG.ADC_NCO_Freq00 {-0.5057331707317073} \
   CONFIG.ADC_NCO_Freq02 {-0.5057331707317073} \
   CONFIG.ADC_NCO_Freq10 {-0.5057331707317073} \
   CONFIG.ADC_NCO_Freq12 {-0.5057331707317073} \
   CONFIG.ADC_NCO_Freq20 {-0.5057331707317073} \
   CONFIG.ADC_NCO_Freq22 {-0.5057331707317073} \
   CONFIG.ADC_NCO_Freq30 {-0.5057331707317073} \
   CONFIG.ADC_NCO_Freq32 {-0.5057331707317073} \
   ...
   CONFIG.DAC0_Outclk_Freq {308.467} \
   CONFIG.DAC0_Refclk_Freq {4935.468} \
   CONFIG.DAC0_Sampling_Rate {4.935468} \
   CONFIG.DAC1_Clock_Source {6} \
   CONFIG.DAC1_Multi_Tile_Sync {true} \
   CONFIG.DAC1_Outclk_Freq {308.467} \
   CONFIG.DAC1_Refclk_Freq {4935.468} \
   CONFIG.DAC1_Sampling_Rate {4.935468} \
   CONFIG.DAC2_Clock_Dist {1} \
   CONFIG.DAC2_Multi_Tile_Sync {true} \
   CONFIG.DAC2_Outclk_Freq {308.467} \
   CONFIG.DAC2_Refclk_Freq {4935.468} \
   CONFIG.DAC2_Sampling_Rate {4.935468} \
   CONFIG.DAC3_Clock_Source {6} \
   CONFIG.DAC3_Multi_Tile_Sync {true} \
   CONFIG.DAC3_Outclk_Freq {308.467} \
   CONFIG.DAC3_Refclk_Freq {4935.468} \
   CONFIG.DAC3_Sampling_Rate {4.935468} \
   ...
   CONFIG.DAC_Interpolation_Mode12 {40} \
   ...
   CONFIG.DAC_Mode00 {0} \
   CONFIG.DAC_NCO_Freq00 {0.49964} \
   CONFIG.DAC_NCO_Freq02 {0.49964} \
   CONFIG.DAC_NCO_Freq10 {0.49964} \
   CONFIG.DAC_NCO_Freq12 {0.49964} \
   CONFIG.DAC_NCO_Freq20 {0.49964} \
   CONFIG.DAC_NCO_Freq22 {0.49964} \
   CONFIG.DAC_NCO_Freq30 {0.49964} \
   CONFIG.DAC_NCO_Freq32 {0.49964} \
...
Port;FD4A0000;FD4AFFFF;0|FPD;DPDMA;FD4C0000;FD4CFFFF;0|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net dac3stream_1 [get_bd_intf_ports dac3stream] [get_bd_intf_pins usp_rf_data_converter_0/s12_axis]
  connect_bd_intf_net -intf_net dac45_1 [get_bd_intf_ports dac45] [get_bd_intf_pins usp_rf_data_converter_0/dac2_clk]
  connect_bd_intf_net -intf_net dac4stream_1 [get_bd_intf_ports dac4stream] [get_bd_intf_pins usp_rf_data_converter_0/s20_axis]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI] [get_bd_intf_pins ddr4_smc_0/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_0_M00_AXI] [get_bd_intf_ports ddr_aximm_dbg] [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI]
  connect_bd_intf_net -intf_net sys_clk_300mhz_1 [get_bd_intf_ports sys_clk_300mhz] [get_bd_intf_pins ddr4_0/C0_SYS_CLK]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m02_axis [get_bd_intf_ports adc1stream] [get_bd_intf_pins usp_rf_data_converter_0/m02_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m03_axis [get_bd_intf_ports adc1Qstream] [get_bd_intf_pins usp_rf_data_converter_0/m03_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m10_axis [get_bd_intf_ports adc2stream] [get_bd_intf_pins usp_rf_data_converter_0/m10_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m11_axis [get_bd_intf_ports adc2Qstream] [get_bd_intf_pins usp_rf_data_converter_0/m11_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m12_axis [get_bd_intf_ports adc3stream] [get_bd_intf_pins usp_rf_data_converter_0/m12_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m13_axis [get_bd_intf_ports adc3Qstream] [get_bd_intf_pins usp_rf_data_converter_0/m13_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m20_axis [get_bd_intf_ports adc4stream] [get_bd_intf_pins usp_rf_data_converter_0/m20_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m21_axis [get_bd_intf_ports adc4Qstream] [get_bd_intf_pins usp_rf_data_converter_0/m21_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m22_axis [get_bd_intf_ports adc5stream] [get_bd_intf_pins usp_rf_data_converter_0/m22_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m23_axis [get_bd_intf_ports adc5Qstream] [get_bd_intf_pins usp_rf_data_converter_0/m23_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m30_axis [get_bd_intf_ports adc6stream] [get_bd_intf_pins usp_rf_data_converter_0/m30_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m31_axis [get_bd_intf_ports adc6Qstream] [get_bd_intf_pins usp_rf_data_converter_0/m31_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m32_axis [get_bd_intf_ports adc7stream] [get_bd_intf_pins usp_rf_data_converter_0/m32_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m33_axis [get_bd_intf_ports adc7Qstream] [get_bd_intf_pins usp_rf_data_converter_0/m33_axis]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_vout32 [get_bd_intf_ports vout7] [get_bd_intf_pins usp_rf_data_converter_0/vout32]
  ...
  connect_bd_intf_net -intf_net vin1_23_0_1 [get_bd_intf_ports vin3] [get_bd_intf_pins usp_rf_data_converter_0/vin1_23]
  connect_bd_intf_net -intf_net vin2_01_0_1 [get_bd_intf_ports vin4] [get_bd_intf_pins usp_rf_data_converter_0/vin2_01]
  ...
  connect_bd_intf_net -intf_net wr_adc_1_axi_1 [get_bd_intf_ports wr_adc_1_axi] [get_bd_intf_pins ddr4_smc_0/S08_AXI]
  connect_bd_intf_net -intf_net wr_adc_axi_1 [get_bd_intf_ports wr_adc_0_axi] [get_bd_intf_pins ddr4_smc_0/S01_AXI]
  connect_bd_intf_net -intf_net wr_fa_1_axi_1 [get_bd_intf_ports wr_fa_1_axi] [get_bd_intf_pins ddr4_smc_0/S10_AXI]
  connect_bd_intf_net -intf_net wr_fa_axi_1 [get_bd_intf_ports wr_fa_0_axi] [get_bd_intf_pins ddr4_smc_0/S03_AXI]
  connect_bd_intf_net -intf_net wr_fa_pos_0_axi_1 [get_bd_intf_ports wr_fa_pos_0_axi] [get_bd_intf_pins ddr4_smc_0/S07_AXI]
  connect_bd_intf_net -intf_net wr_fa_pos_1_axi_1 [get_bd_intf_ports wr_fa_pos_1_axi] [get_bd_intf_pins ddr4_smc_0/S14_AXI]
  connect_bd_intf_net -intf_net wr_ph_1_axi_1 [get_bd_intf_ports wr_ph_1_axi] [get_bd_intf_pins ddr4_smc_0/S12_AXI]
  connect_bd_intf_net -intf_net wr_ph_axi_1 [get_bd_intf_ports wr_ph_0_axi] [get_bd_intf_pins ddr4_smc_0/S05_AXI]
  connect_bd_intf_net -intf_net wr_pl_1_axi_1 [get_bd_intf_ports wr_pl_1_axi] [get_bd_intf_pins ddr4_smc_0/S11_AXI]
  connect_bd_intf_net -intf_net wr_pl_axi_1 [get_bd_intf_ports wr_pl_0_axi] [get_bd_intf_pins ddr4_smc_0/S04_AXI]
  connect_bd_intf_net -intf_net wr_tbt_1_axi_1 [get_bd_intf_ports wr_tbt_1_axi] [get_bd_intf_pins ddr4_smc_0/S09_AXI]
  connect_bd_intf_net -intf_net wr_tbt_axi_1 [get_bd_intf_ports wr_tbt_0_axi] [get_bd_intf_pins ddr4_smc_0/S02_AXI]
  connect_bd_intf_net -intf_net wr_tbt_pos_0_axi_1 [get_bd_intf_ports wr_tbt_pos_0_axi] [get_bd_intf_pins ddr4_smc_0/S06_AXI]
  connect_bd_intf_net -intf_net wr_tbt_pos_1_axi_1 [get_bd_intf_ports wr_tbt_pos_1_axi] [get_bd_intf_pins ddr4_smc_0/S13_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins ddr4_smc_0/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]

  # Create port connections
  connect_bd_net -net FPGA_REFCLK_OUT_C_1 [get_bd_ports FPGA_REFCLK_OUT_C] [get_bd_pins rfadc_mmcm/clk_in1]
  connect_bd_net -net GPIO_IN_1 [get_bd_ports GPIO_IN] [get_bd_pins axi_lite_generic_reg_0/GPIO_IN]
  connect_bd_net -net Zero_dout [get_bd_pins Zero/dout] [get_bd_pins evr_axi_0/TsRequest]
  connect_bd_net -net axi_lite_generic_reg_0_GPIO_OUT [get_bd_ports GPIO_OUT] [get_bd_pins axi_lite_generic_reg_0/GPIO_OUT]
  connect_bd_net -net axi_lite_generic_reg_0_GPIO_STROBES [get_bd_ports GPIO_STROBES] [get_bd_pins axi_lite_generic_reg_0/GPIO_STROBES]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports adcClk] [get_bd_ports dacClk] [get_bd_pins ddr4_smc_0/aclk1] [get_bd_pins rfadc_mmcm/clk_out1] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/m1_axis_aclk] [get_bd_pins usp_rf_data_converter_0/m2_axis_aclk] [get_bd_pins usp_rf_data_converter_0/m3_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s2_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s3_axis_aclk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_ports ddr4_ui_clk] [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins ddr4_smc_0/aclk] [get_bd_pins rst_ddr_mig_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk_sync_rst [get_bd_ports ddr4_rst] [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst] [get_bd_pins rst_ddr_mig_0/ext_reset_in]
  ...
  connect_bd_net -net rst_ddr_mig_0_peripheral_aresetn [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins ddr4_smc_0/aresetn] [get_bd_pins rst_ddr_mig_0/peripheral_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_dac0 [get_bd_ports clk_dac0_0] [get_bd_pins usp_rf_data_converter_0/clk_dac0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports sysClk] [get_bd_pins axi_lite_generic_reg_0/s00_axi_aclk] [get_bd_pins ddr4_smc_0/aclk2] [get_bd_pins evr_axi_0/s00_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rfadc_mmcm/s_axi_aclk] [get_bd_pins rst_ps8_0_96M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_adc_0_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_adc_1_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_fa_0_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_fa_1_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_fa_pos_0_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_fa_pos_1_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_ph_0_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_ph_1_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_pl_0_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_pl_1_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_tbt_0_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_tbt_1_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_tbt_pos_0_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces wr_tbt_pos_1_axi] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
