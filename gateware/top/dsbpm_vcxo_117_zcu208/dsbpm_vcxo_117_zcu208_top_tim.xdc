...
set clk_adc_period                    [get_property PERIOD [get_clocks -of_objects [get_pins -hier -filter {NAME =~ *system_i/rfadc_mmcm/inst/CLK_CORE_DRP_I/clk_inst/mmcme4_adv_inst/CLKOUT0}]]]
set clk_dac_period                    [get_property PERIOD [get_clocks -of_objects [get_pins -hier -filter {NAME =~ *system_i/rfadc_mmcm/inst/CLK_CORE_DRP_I/clk_inst/mmcme4_adv_inst/CLKOUT1}]]]
...
set_max_delay -datapath_only -from [get_clocks clk_pl_0] -to [get_clocks -of_objects [get_pins -hier -filter {NAME =~ *system_i/rfadc_mmcm/inst/CLK_CORE_DRP_I/clk_inst/mmcme4_adv_inst/CLKOUT1}]] $clk_dac_period
# EVR to DAC clock, EVR hearbeat marker
set_max_delay -datapath_only -from [get_clocks -hier -filter {NAME =~ *gtye4_channel_gen.gen_gtye4_channel_inst[0].GTYE4_CHANNEL_PRIM_INST_1}] -to [get_clocks -of_objects [get_pins -hier -filter {NAME =~ *system_i/rfadc_mmcm/inst/CLK_CORE_DRP_I/clk_inst/mmcme4_adv_inst/CLKOUT1}]] $clk_dac_period
...
set_max_delay -datapath_only -from [get_clocks clk_pl_0] -to [get_clocks -hier -filter {NAME =~ *gtye4_channel_gen.gen_gtye4_channel_inst[0].GTYE4_CHANNEL_PRIM_INST_1}] $clk_mgt_rx_period
set_max_delay -datapath_only -from [get_clocks -hier -filter {NAME =~ *gtye4_channel_gen.gen_gtye4_channel_inst[0].GTYE4_CHANNEL_PRIM_INST_1}] -to [get_clocks clk_pl_0] $clk_pl_0_period
...
# only used for monitoring and debug
set_max_delay -datapath_only -from [get_clocks -hier -filter {NAME =~ *gtye4_channel_gen.gen_gtye4_channel_inst[0].GTYE4_CHANNEL_PRIM_INST_1}] -to [get_clocks -of_objects [get_pins -hier -filter {NAME =~ *system_i/ddr4_0/inst/u_ddr4_infrastructure/gen_mmcme4.u_mmcme_adv_inst/CLKOUT0}]] $clk_ddr_ui_period
set_max_delay -datapath_only -from [get_clocks -of_objects [get_pins -hier -filter {NAME =~ *system_i/ddr4_0/inst/u_ddr4_infrastructure/gen_mmcme4.u_mmcme_adv_inst/CLKOUT0}]] -to [get_clocks -hier -filter {NAME =~ *gtye4_channel_gen.gen_gtye4_channel_inst[0].GTYE4_CHANNEL_PRIM_INST_1}] $clk_mgt_rx_period
...
set_false_path -from [get_clocks FPGA_REFCLK_OUT_C_P] -to [get_clocks -of_objects [get_pins -hier -filter {NAME =~ *system_i/rfadc_mmcm/inst/CLK_CORE_DRP_I/clk_inst/mmcme4_adv_inst/CLKOUT1}]]
# Set false path between ADC clock and RX MGT clock. Safely crossing domains already
# and with ASYNC_REG properties in RTL.
set_false_path -from [get_clocks clk_out1_system_rfadc_mmcm_0] -to [get_clocks -hier -filter {NAME =~ *gtye4_channel_gen.gen_gtye4_channel_inst[0].GTYE4_CHANNEL_PRIM_INST_1}]
set_false_path -from [get_clocks -hier -filter {NAME =~ *gtye4_channel_gen.gen_gtye4_channel_inst[0].GTYE4_CHANNEL_PRIM_INST_1] -to [get_clocks clk_out1_system_rfadc_mmcm_0}]
