...
common_dsbpm_top #(
    ...
    .DAC_WIDTH(DAC_WIDTH),
    .AXI_DAC_SAMPLE_WIDTH(AXI_DAC_SAMPLE_WIDTH),
    .IQ_DATA(IQ_DATA),
    .SYSCLK_RATE(SYSCLK_RATE),
    .ADC_CHANNEL_COUNT(ADC_CHANNEL_COUNT),
    .ADC_SAMPLES_PER_CLOCK(ADC_SAMPLES_PER_CLOCK),
    .ADC_WORDS_PER_CHANNEL(ADC_WORDS_PER_CHANNEL),
    .ADC_CHANNEL_DEBUG(ADC_CHANNEL_DEBUG),
    .DAC_CHANNEL_COUNT(DAC_CHANNEL_COUNT),
    .DAC_SAMPLES_PER_CLOCK(DAC_SAMPLES_PER_CLOCK),
    .DAC_WORDS_PER_CHANNEL(DAC_WORDS_PER_CHANNEL),
    .LO_WIDTH(LO_WIDTH),
    .MAG_WIDTH(MAG_WIDTH),
